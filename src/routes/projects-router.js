...
router.post('/projects/create', ProjectValidate.create(), ProjectController.create)

router.get('/projects/index', ProjectController.index)

router.delete('/projects/delete/:id', ProjectController.destroy)

router.put('/projects/update/:id', ProjectValidate.update(), ProjectController.update)
